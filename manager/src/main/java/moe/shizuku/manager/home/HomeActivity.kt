...
import moe.shizuku.manager.cache.CacheClearActivity
        ...
        return when (item.itemId) {
            R.id.action_cache_clear -> {
                if (Shizuku.pingBinder()) {
                    startActivity(Intent(this, CacheClearActivity::class.java))
                } else {
                    MaterialAlertDialogBuilder(this)
                        .setMessage(R.string.cache_clear_requires_shizuku)
