...
function App() {
  ...
  return <div className="page">
    ...
    <main className="main">
      ...
      <div className="features"><Feature icon={<Zap size={17} />} title="এক ঝলকে" text="সত্যিকারের ছোট URL" /><Feature icon={<LockKeyhole size={17} />} title="গোপনীয়" text="শুধু ছোট করার জন্য পাঠানো হয়" /><Feature icon={<Link2 size={17} />} title="সর্বত্র কাজ করে" text="সব ব্রাউজারে" /></div>
    </main>
